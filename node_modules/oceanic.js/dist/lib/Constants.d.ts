...
import type { RawAnnouncementChannel, RawAnnouncementThreadChannel, RawCategoryChannel, RawForumChannel, RawGroupChannel, RawPrivateChannel, RawPrivateThreadChannel, RawPublicThreadChannel, RawStageChannel, RawTextChannel, RawVoiceChannel } from "./types/channels";
...
export declare const GuildChannelTypesWithoutThreads: (ChannelTypes.GUILD_TEXT | ChannelTypes.GUILD_VOICE | ChannelTypes.GUILD_CATEGORY | ChannelTypes.GUILD_ANNOUNCEMENT | ChannelTypes.GUILD_STAGE_VOICE | ChannelTypes.GUILD_DIRECTORY | ChannelTypes.GUILD_FORUM)[];
...
export declare const TextableChannelTypesWithoutThreads: (ChannelTypes.GUILD_TEXT | ChannelTypes.DM | ChannelTypes.GUILD_VOICE | ChannelTypes.GUILD_ANNOUNCEMENT | ChannelTypes.GUILD_STAGE_VOICE)[];
export declare const TextableGuildChannelTypesWithoutThreads: (ChannelTypes.GUILD_TEXT | ChannelTypes.GUILD_VOICE | ChannelTypes.GUILD_ANNOUNCEMENT | ChannelTypes.GUILD_STAGE_VOICE)[];
export declare const VoiceChannelTypes: readonly [ChannelTypes.GUILD_VOICE, ChannelTypes.GUILD_STAGE_VOICE];
export declare const InviteChannelTypes: readonly [ChannelTypes.GUILD_TEXT, ChannelTypes.GUILD_ANNOUNCEMENT, ChannelTypes.GUILD_VOICE, ChannelTypes.GUILD_STAGE_VOICE, ChannelTypes.GUILD_FORUM];
...
export declare const ConnectionServices: readonly ["battlenet", "ebay", "epicgames", "facebook", "github", "instagram", "leagueoflegends", "paypal", "playstation", "reddit", "riotgames", "spotify", "skype", "steam", "tiktok", "twitch", "twitter", "xbox", "youtube"];
...
export declare namespace Permissions {
    ...
    const MANAGE_EMOJIS_AND_STICKERS = 1073741824n;
